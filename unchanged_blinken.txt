...
static void updateOutput_D6(uint64_t tick, state_t *state) {
  if (state->mode == FLYING) {
    switch (tick) {
      case cycle_fraction(0, 40):   analogWrite(6, 100); break;
      case cycle_fraction(1, 40):   analogWrite(6, 0);  break;
      case cycle_fraction(4, 40):   analogWrite(6, 100);  break;
      case cycle_fraction(5, 40):   analogWrite(6, 0);  break;
      case cycle_fraction(6, 40):   analogWrite(6, 100);  break;
      case cycle_fraction(7, 40):   analogWrite(6, 0);  break;
      case cycle_fraction(8, 40):   analogWrite(6, 100);  break;
      case cycle_fraction(9, 40):   analogWrite(6, 0);  break;
      case cycle_fraction(10, 40):   analogWrite(6, 100);  break;
      case cycle_fraction(11, 40):   analogWrite(6, 0);  break;
    }
  } else if (state->mode == STANDBY) {
    switch (tick) {
      case 0:       analogWrite(6, 100); break;
      case cycle_fraction(1, 2):   analogWrite(6, 0);  break;
    }
  }
}
...
static void updateOutput_D10(uint64_t tick, state_t *state) {
  switch (tick) {
    case 0: analogWrite(10, 0); break;
    case cycle_fraction(8,  20): analogWrite(10, 100);  break;
    case cycle_fraction(9,  20): analogWrite(10, 0); break;
    case cycle_fraction(10, 20): analogWrite(10, 100);  break;
    case cycle_fraction(11, 20): analogWrite(10, 0); break;
  }
}
